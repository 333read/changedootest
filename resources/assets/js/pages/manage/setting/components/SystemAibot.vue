<template>
    <div class="setting-component-item">
        <Form ref="formData" :model="formData" :rules="ruleData" label-width="auto" @submit.native.prevent>
            ...
            <!-- custom系统 -->
            <div class="block-setting-box" v-if="type=='all' || type=='Custom'">
                <h3>Custom</h3>
                <div class="form-box">
                    <FormItem label="API Key" prop="custom_key">
                        <Input :maxlength="255" v-model="formData.custom_key" type="password" placeholder="API Key"/>
                        <div class="form-tip">{{$L('获取方式')}} <a href="https://open.bigmodel.cn/usercenter/apikeys" target="_blank">https://open.bigmodel.cn/usercenter/apikeys</a></div>
                    </FormItem>
                    <FormItem :label="$L('模型')" prop="custom_model">
                        <Select v-model="formData.custom_model" placement="top" transfer>
                            <Option value="ChatGLM4-9B">ChatGLM4-9B</Option>
                        </Select>
                        <div class="form-tip">{{$L('查看说明')}} <a href="https://open.bigmodel.cn/dev/howuse/model" target="_blank">https://open.bigmodel.cn/dev/howuse/model</a></div>
                    </FormItem>
                </div>
